"""Investigates the minimum number of points needed to accurately
...
for n in nVals:
    ...
    time_step = t[1] - t[0]
    num_time_pts = len(t)
    I, amt = st.solve_reaction_dimensional(time_step, num_time_pts, E_0, dE,
                                           freq, k_0, Ru, Cdl, Cdl1, Cdl2,
                                           Cdl3, EStart, ERev, temp, nu,
                                           area, coverage, True)
    IVals.append(I)
    print "\tDone"
